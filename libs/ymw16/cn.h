...
int ymw16par(struct Warp_Sun* t0, struct Thick* t1, struct Thin* t2, struct Spiral* t3, struct GC* t4, struct Gum* t5,
        struct LB* t6, struct LI* t7, struct FB* t8, struct LMC* t9, struct Dora* t10, struct SMC* t11, char* dirname);
void ne_ncrd(double xx, double yy, double zz, double gl, double gb, double dist, int ncrd, int vbs, char* dirname,
        char* text);
...
double ne_crd(double* x, double* y, double* z, double* gl, double* gb, double* dd, int ncrd, int vbs, char* dirname,
        char* text);
